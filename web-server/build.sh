...
# STRIP=${SDK_PATH}/gcc/linux-x86/aarch64/toolchain-sunxi-glibc/toolchain/bin/aarch64-openwrt-linux-gnu-strip
...
# STRIP=${SDK_PATH}/gcc/linux-x86/arm/toolchain-sunxi-arm9-musl/toolchain/bin/arm-openwrt-linux-muslgnueabi-strip
# TARGET_CFLAGS="-I${SDK_PATH}/dl/include/"
# TARGET_LDFLAGS="-L${SDK_PATH}/dl/lib/"
# F1C200S交叉编译工具
...
STRIP=${CROSS_COMPILE_TOOL}strip
