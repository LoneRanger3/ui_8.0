...
typedef struct _lv_group_t {
    ...
    uint8_t wrap : 1;           /**< 1: Focus next/prev can wrap at end of list. 0: Focus next/prev stops at end
                                   of list.*/
    bool en_cycle;              /**< modify chenwenke: true: enable cycle, false: disable cycle*/
} lv_group_t;
...
/**
 * @description: modify chenwenke: enable group cycle
 * @return {*}
 * @param {lv_group_t *} group
 * @param {bool} en  true: enable cycle, false: disable cycle
 */
void lv_group_focus_cycle(lv_group_t * group, bool en);
