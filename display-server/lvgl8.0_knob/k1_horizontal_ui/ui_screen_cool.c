 ...
 * @LastEditTime: 2023-08-15 03:52:16
 */
...
void ui_ScreenCool_screen_init(void)
{
    ...
    lv_obj_set_height(ui_PanelTitleScreenCool, 52);
    ...
    lv_obj_set_x(ui_PanelMoveScreenCool, 1);
    lv_obj_set_y(ui_PanelMoveScreenCool, -18);
    ...
    lv_obj_set_x(ui_PanelFilamentScreenCool, 242);
    lv_obj_set_y(ui_PanelFilamentScreenCool, -18);
    ...
    lv_obj_set_x(ui_PanelCoolScreenCool, 444);
    lv_obj_set_y(ui_PanelCoolScreenCool, -18);
