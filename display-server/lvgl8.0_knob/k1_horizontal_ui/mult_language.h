 ...
 * @LastEditTime: 2023-10-20 06:06:11
 */
/**
...
extern const char *PrivacycontentPreview[MAX_LANGUAGE];
extern const char *Reconsider[MAX_LANGUAGE];
extern const char *LookOver[MAX_LANGUAGE];
...
extern const char *UploadErrorTips1[MAX_LANGUAGE];
...
extern const char *InsertUdisk[MAX_LANGUAGE];
...
extern const char *Control[MAX_LANGUAGE]; //控制
extern const char *File[MAX_LANGUAGE]; // 文件
extern const char *Setting[MAX_LANGUAGE]; //设置
extern const char *LanguageSelection[MAX_LANGUAGE];  //语言选择
extern const char *LanguageSelectionTips[MAX_LANGUAGE];
extern const char *CameraArray[MAX_LANGUAGE];  //摄像头
extern const char *CameraSetting[MAX_LANGUAGE];//摄像头设置
extern const char *SettingArray[MAX_LANGUAGE]; //设置
extern const char *VedioList[MAX_LANGUAGE];    //视频列表
extern const char *EnableArray[MAX_LANGUAGE];  //启用
extern const char *DisableArray[MAX_LANGUAGE]; //未启用
extern const char *Detection[MAX_LANGUAGE];   //检测
...
extern const char *StartAdjust[MAX_LANGUAGE];     //开始校准
extern const char *StartLevel[MAX_LANGUAGE];      //开始调平
extern const char *HotendArray[MAX_LANGUAGE];     //喷头
extern const char *BedArray[MAX_LANGUAGE];        //热床
extern const char *PIDAdjustment[MAX_LANGUAGE];   //PID校准
...
extern const char *X_AxisMove[MAX_LANGUAGE];
extern const char *Y_AxisMove[MAX_LANGUAGE];
extern const char *Z_AxisMove[MAX_LANGUAGE];
...
extern const char *Error8[MAX_LANGUAGE];            //错误告警8
...
extern const char *Fans[MAX_LANGUAGE];
...
extern const char * Bed_temp[MAX_LANGUAGE];
extern const char * Turn_off_the_motor[MAX_LANGUAGE];

/**********************adjustment*************************/
extern const char *Adjustment[MAX_LANGUAGE];
extern const char *UnitSetting[MAX_LANGUAGE];
extern const char *FlowTipsMsg[MAX_LANGUAGE];
extern const char *SpeedTipsMsg[MAX_LANGUAGE];
...
/**********************sub dir*************************/
extern const char *RootDirTipsMsg[MAX_LANGUAGE];
extern const char *DirNameTipsMsg[MAX_LANGUAGE];
extern const char *FileCountTipsMsg[MAX_LANGUAGE];
extern const char *DirIndexTipsMsg[MAX_LANGUAGE];

/**********************print history*************************/
extern const char *NoRecords[MAX_LANGUAGE];
extern const char *RecordIndexTipsMsg[MAX_LANGUAGE];
extern const char *PrintAgain[MAX_LANGUAGE];
extern const char *Page[MAX_LANGUAGE];
extern const char *Copy[MAX_LANGUAGE];
...
extern const char *LayerArray[MAX_LANGUAGE];              //层
extern const char *ShootMsg[MAX_LANGUAGE];                //拍照
extern const char *LayerStartPos[MAX_LANGUAGE];           //层开始位置
extern const char *HotendMoveAway[MAX_LANGUAGE];          //喷头移开时
// extern const char *DelayPhotograph[MAX_LANGUAGE];         //延迟摄影

/***********************vedio info****************************/
extern const char *VedioInformation[MAX_LANGUAGE];        //视频详情
extern const char *MoveAwayArray[MAX_LANGUAGE];           //移开
extern const char *NoMoveAwayArray[MAX_LANGUAGE];         //不移开
...
extern const char *Version[MAX_LANGUAGE];                 //版本
...
/*************************touch tone***********************/
extern const char *TouchToneArray[MAX_LANGUAGE];          //按键音
extern const char *TouchToneSwitch[MAX_LANGUAGE];         //按键音开关
...
extern const char *NoOptArray[MAX_LANGUAGE];              //无操作
...
extern const char *PasswordLenLimit[MAX_LANGUAGE];        //密码长度限制
...
extern const char *TurnOnModelFan[MAX_LANGUAGE];         //开启模型冷却风扇
extern const char *TurnOnThroatFan[MAX_LANGUAGE];        //开启喉管散热风扇
...
extern const char *HomeArray[MAX_LANGUAGE];              //归位
extern const char *XY_HomeArray[MAX_LANGUAGE];              //归位
extern const char *Z_HomeArray[MAX_LANGUAGE];              //归位
extern const char *ProbeArray[MAX_LANGUAGE];             //探针
extern const char *RunoutArray[MAX_LANGUAGE];            //断料
...
extern const char *SelfTestCleanTip[MAX_LANGUAGE];       //请保持热床和喷嘴清洁提示
extern const char *SelfTestTimeTip[MAX_LANGUAGE];        //自检过程时长提示

/*************************self test network***********************/
extern const char *PleaseSetNetwork[MAX_LANGUAGE];      //请设置您的网络
extern const char *SettingNetwork[MAX_LANGUAGE];      //设置网络
...
/*********************set time***************************/
extern const char *UtcTime[MAX_LANGUAGE];               //UTC 时间 
extern const char *LocalTime[MAX_LANGUAGE];             //本地时间
...
extern const char *ErrorBtnFileManagement[MAX_LANGUAGE];//错误清理按钮
