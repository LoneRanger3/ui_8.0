 ...
 * @LastEditTime: 2023-09-16 07:46:24
 */
#include "ui.h"
...
void ui_Exportlog_screen_init(void)
{
    ...
    lv_obj_set_width(ui_ExportlogLabel1, 150);
    ...
    lv_obj_set_x(ui_ExportlogButton1, 419);
    lv_obj_set_y(ui_ExportlogButton1, 381);
    ...
    lv_label_set_long_mode(ui_ExportlogBtnlabel1, LV_LABEL_LONG_SCROLL_CIRCULAR);
    ...
    lv_obj_set_width(ui_ExportlogPanel4label, LV_SIZE_CONTENT);
    ...
    lv_obj_set_style_text_color(ui_ExportlogPanel4label, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ExportlogButton2, 560);
    lv_obj_set_y(ui_ExportlogButton2, 381);
    ...
    lv_label_set_long_mode(ui_ExportlogBtnlabel2, LV_LABEL_LONG_SCROLL_CIRCULAR);
...
void ui_event_ExportlogButton2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        ...
        // ui_Exportmbox1 = lv_msgbox_create(NULL, "", LogExportingMsg[get_cur_language_index()], btns, false);
        // lv_obj_set_width(ui_Exportmbox1, 276);
        // lv_obj_set_height(ui_Exportmbox1, 71);
        // lv_obj_clear_flag(ui_Exportmbox1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
        // lv_obj_set_style_bg_color(ui_Exportmbox1, lv_color_hex(0x36383C), LV_PART_MAIN | LV_STATE_DEFAULT);
        // lv_obj_set_style_border_color(ui_Exportmbox1, lv_color_hex(0x434549), LV_PART_MAIN | LV_STATE_DEFAULT);
        // lv_obj_set_style_border_width(ui_Exportmbox1, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
        // lv_obj_set_style_text_font(ui_Exportmbox1, lv_font24.font, LV_PART_MAIN | LV_STATE_DEFAULT);
        // lv_obj_set_style_text_color(ui_Exportmbox1, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
        // lv_obj_add_event_cb(ui_Exportmbox1, event_cb, LV_EVENT_ALL, NULL);
        // lv_obj_center(ui_Exportmbox1);
...
// {
//     CrLogI("refresh the exprot log ,state is %d.",flag);
//     switch (flag)
//     {
//     case 0:create_msgbox(LogExportingMsg[get_cur_language_index()], NULL, 0, lv_scr_act());
//             break;
//     case 1:create_msgbox(LogExportSuccessMsg[get_cur_language_index()], NULL, 2000, lv_scr_act());
//             break;
//     case 2:create_msgbox(LogExportFailedMsg[get_cur_language_index()], NULL, 2000, lv_scr_act());
//            break;
//     case 3:create_msgbox(DiskUMsg[get_cur_language_index()], NULL, 2000, lv_scr_act());
//            break;
//     default:
//         break;
//     }   
...
void refreshmsgbox(int flag, int process)
{
    ...
    switch (flag)
    {
        case 0:
        {
            ...
            create_msgbox(tempbuff, &ui_img_wait_png, 0, lv_scr_act());
            break;
        }
        case 1:create_msgbox(LogExportSuccessMsg[get_cur_language_index()], &ui_img_ExportSucceeded_png, 2000, lv_scr_act());startexprotlogtolocal = false;break;
        case 2:create_msgbox(LogExportFailedMsg[get_cur_language_index()], &ui_img_ExportFailed_png, 2000, lv_scr_act());startexprotlogtolocal = false;break;
        case 3:create_msgbox(DiskUMsg[get_cur_language_index()], &ui_img_ExportFailed_png, 2000, lv_scr_act());break;
