...
#define TOUCH_TEST_FLAG  0 //触摸测试,使能时注意修改 item_text 和 ITEM_NUM
#define ITEM_NUM 11 //13 该值依据测试项数量设置
...
static lv_obj_t *ui_PanelFactoryTest;
...
static void FactoryLcdTestAddObjToGroup(void);
static void FactoryTestChangeObjs(uint8_t index);
...
static void factory_ReportMESQrcode(int uid,int result, json_object* gy, json_object *detail,char *describe)
{
    ...
    lv_obj_set_size(reportCont, lv_obj_get_width(lv_layer_top()), 360);
    
    // 创建二维码
    lv_obj_t *reportQrcode = lv_qrcode_create(reportCont, 355, lv_color_hex(0xFFFFFF), lv_color_hex(0x000000));
    // 返回按键
    ...
    lv_group_add_obj(encoder_group, returnBtn);
...
static void auto_next_test(int index)
{
    ...
    {
        LoadPage(ui_ScreenFactoryTestScreen, 1);
        lv_group_focus_obj(ui_ItemObj[index]);
    }
}
...
static void factory_item_lcd_test_init(void)
{
    ...
    lv_obj_set_style_bg_color(item_lcd_obj, lv_color_hex(0x1F1F20), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_size(item_lcd_obj, 640, 360);
    lv_obj_set_pos(item_lcd_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_lcd_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_lcd_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_lcd_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_lcd_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_lcd_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_lcd_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_lcd_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_lcd_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_lcd_retest_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_lcd_retest_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_lcd_retest_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_lcd_retest_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 2);
}
...
static void factory_item_touch_test_init(void)
{
    ...
    lv_obj_set_size(item_touch_obj, 640, 360);
    lv_obj_set_pos(item_touch_obj, 0, 60);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 3);
}
...
void factory_item_eeprom_test_init(void)
{
    ...
    lv_obj_set_size(item_eeprom_obj, 640, 360);
    lv_obj_set_pos(item_eeprom_obj, 0, 60);
...
static void factory_item_gpio_test_init(void)
{
    ...
    lv_obj_set_size(item_gpio_obj, 640, 360);
    lv_obj_set_pos(item_gpio_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_align_to(item_gpio_btn0, item_gpio_obj, LV_ALIGN_TOP_LEFT, 20, 80);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn0, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn0, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn0, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn0, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn1, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn1, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn1, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn1, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn4, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn4, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn4, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn4, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_align_to(item_gpio_btn2, item_gpio_btn4, LV_ALIGN_OUT_RIGHT_MID, 20, 0);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn2, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn2, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn2, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn2, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn3, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn3, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn3, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn3, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_gpio_btn5, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_gpio_btn5, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_gpio_btn5, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_gpio_btn5, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    item_gpio_filament_label = ui_factory_add_label(item_gpio_obj, gpio_filament_text, lv_font25.font, lv_color_white(),
                                                    LV_ALIGN_RIGHT_MID, item_gpio_obj, -30, 15);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 4);
...
static void factory_item_adc_test_init(void)
{
    ...
    lv_obj_set_size(item_adc_obj, 640, 360);
    lv_obj_set_pos(item_adc_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_adc_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_adc_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_adc_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_adc_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_adc_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_adc_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_adc_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_adc_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_align_to(item_adc_bed_label, item_adc_obj, LV_ALIGN_CENTER, -60, -20);
    ...
    lv_obj_align_to(item_adc_case_label, item_adc_bed_label, LV_ALIGN_OUT_BOTTOM_MID, 0, 0);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 5);
}
//==========USB测试相关==========
/**
...
static void factory_item_usb_test_init(void)
{
    ...
    lv_obj_set_size(item_usb_obj, 640, 360);
    lv_obj_set_pos(item_usb_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_usb_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_usb_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_usb_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_usb_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_usb_retest_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_usb_retest_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_usb_retest_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_usb_retest_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_usb_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_usb_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_usb_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_usb_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_align_to(item_usb_size_label, item_usb_size_text_label, LV_ALIGN_OUT_RIGHT_MID, 25, 0);
    refresh_factory_usb_status();
    LoadPage(ui_ScreenFactoryTestScreen, 6);
}
...
static void factory_item_mcu_test_init(void)
{
    ...
    lv_obj_set_size(item_mcu_obj, 640, 360);
    lv_obj_set_pos(item_mcu_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_mcu_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_mcu_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_mcu_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_mcu_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_mcu_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_mcu_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_mcu_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_mcu_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    get_printer_data(0x03, 1, "\0");    //温度更新
    LoadPage(ui_ScreenFactoryTestScreen, 7);
}
//==========电机测试相关==========
/**
...
static void factory_item_motor_test_init(void)
{
    ...
    lv_obj_set_size(item_motor_obj, 640, 360);
    lv_obj_set_pos(item_motor_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_motor_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_return_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_motor_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_pass_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_pass_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_motor_y_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_y_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_y_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_y_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_motor_x_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_x_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_x_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_x_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_motor_z_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_z_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_z_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_z_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_motor_e_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_motor_e_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_motor_e_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_motor_e_btn, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_align_to(item_motor_e_btn, item_motor_y_btn, LV_ALIGN_OUT_BOTTOM_MID, 0, 20);
    
    //未启用控件
    lv_obj_add_flag(item_motor_e_btn, LV_OBJ_FLAG_HIDDEN);
    LoadPage(ui_ScreenFactoryTestScreen, 8);
}
...
static void factory_item_wifi_test_init(void)
{
    ...
    lv_obj_set_size(item_wifi_obj, 640, 360);
    lv_obj_set_pos(item_wifi_obj, 0, 60);
...
static void factory_item_net_test_init(void)
{
    ...
    lv_obj_set_size(item_net_obj, 640, 360);
    lv_obj_set_pos(item_net_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_touch_return_net, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_return_net, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_return_net, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_return_net, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_touch_pass_net, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_pass_net, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_pass_net, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_pass_net, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 9);
}
...
static void factory_item_buzzer_test_init()
{
    ...
    lv_obj_set_size(item_buzzer_obj, 640, 360);
    lv_obj_set_pos(item_buzzer_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_touch_return_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_return_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_return_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_return_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_touch_pass_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_pass_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_pass_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_pass_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_paly_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_paly_buzzer, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_paly_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_paly_buzzer, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 10);
}
...
static void factory_item_version_test_init()
{
    ...
    lv_obj_set_size(item_version_obj, 640, 360);
    lv_obj_set_pos(item_version_obj, 0, 60);
    ...
    lv_obj_set_style_shadow_spread(item_touch_return_version, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_return_version, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_return_version, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_return_version, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_shadow_spread(item_touch_pass_version, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(item_touch_pass_version, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(item_touch_pass_version, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(item_touch_pass_version, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_align_to(item_ersion_fw_text, item_version_obj, LV_ALIGN_TOP_MID, -70, 20);
    // 硬件版本
    memset(cmd, 0, sizeof(cmd));
    ...
    LoadPage(ui_ScreenFactoryTestScreen, 11);
...
void LoadFactotytestScreen(void)
{
   LoadPage(ui_ScreenFactoryTestScreen, 1);
}
...
void ui_ScreenFactoryTest_screen_init(void)
{
    ...
    init_pages(ui_ScreenFactoryTestScreen, FactoryTestChangeObjs, ui_load_FactotytestScreen);
    
    ui_PanelFactoryTest = lv_obj_create(ui_ScreenFactoryTestScreen);
    lv_obj_set_size(ui_PanelFactoryTest, 640, 360);
    lv_obj_set_pos(ui_PanelFactoryTest, 0, 60);
    lv_obj_clear_flag(ui_PanelFactoryTest, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(ui_PanelFactoryTest, lv_color_hex(0x1F1F20), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_PanelFactoryTest, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_PanelFactoryTest, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_all(ui_PanelFactoryTest, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_PanelFactoryTest, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_factory_title_label = ui_factory_add_label(ui_PanelFactoryTest, title_text, lv_font25.font,
                                                  lv_color_white(), LV_ALIGN_TOP_MID, ui_PanelFactoryTest, 0, 25);

    ui_factory_return_btn = ui_factory_add_btn(ui_PanelFactoryTest, 130, 50, lv_color_hex(0x4190A2), return_text, 
                                                   lv_color_white(), lv_font25.font, factory_test_finish_return_cb, NULL);
    lv_obj_set_style_border_color(ui_factory_return_btn, lv_color_hex(0xB0F1FF),
                                  LV_PART_MAIN | LV_STATE_FOCUS_KEY); 
    lv_obj_set_style_border_opa(ui_factory_return_btn, 255, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_radius(ui_factory_return_btn, 5, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_spread(ui_factory_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(ui_factory_return_btn, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(ui_factory_return_btn, lv_color_hex(0xB0F1FF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(ui_factory_return_btn, lv_color_hex(0xB0F1FF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_align_to(ui_factory_return_btn, ui_PanelFactoryTest, LV_ALIGN_TOP_LEFT, 10, 30);

    ui_factory_auto_test_sw = lv_switch_create(ui_PanelFactoryTest);
    ...
    lv_obj_set_style_shadow_spread(ui_factory_auto_test_sw, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_pad(ui_factory_auto_test_sw, 3, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_shadow_color(ui_factory_auto_test_sw, lv_color_hex(0xB0F1FF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_color(ui_factory_auto_test_sw, lv_color_hex(0xB0F1FF), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_align_to(ui_factory_auto_test_sw, ui_PanelFactoryTest, LV_ALIGN_TOP_RIGHT, -20, 25);

    auto_test_label = ui_factory_add_label(ui_PanelFactoryTest, auto_test_text, lv_font25.font, lv_color_white(),
    ...
    ui_ItemCont = lv_obj_create(ui_PanelFactoryTest);
    ...
    lv_obj_set_size(ui_ItemCont, 640, 280);
    ...
    lv_obj_align_to(ui_ItemCont, ui_PanelFactoryTest, LV_ALIGN_BOTTOM_MID, 0, 0);
    ...
    for (i = 0; i < ITEM_NUM; i++)
    {
        ...
        lv_obj_add_flag(ui_ItemObj[i], LV_OBJ_FLAG_SCROLL_ON_FOCUS);
        ...
        lv_obj_set_style_border_side(ui_ItemObj[i], LV_BORDER_SIDE_FULL, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
        lv_obj_set_style_border_color(ui_ItemObj[i], lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
...
void FactoryLcdTestAddObjToGroup(void)
{
    lv_group_remove_all_objs(encoder_group);
    if (!lv_obj_has_flag(item_lcd_next_btn, LV_OBJ_FLAG_HIDDEN)) {
        lv_group_add_obj(encoder_group, item_lcd_next_btn);
    }
    if (!lv_obj_has_flag(item_lcd_return_btn, LV_OBJ_FLAG_HIDDEN)) {
        lv_group_add_obj(encoder_group, item_lcd_return_btn);
    }
    if (!lv_obj_has_flag(item_lcd_pass_btn, LV_OBJ_FLAG_HIDDEN)) {
        lv_group_add_obj(encoder_group, item_lcd_pass_btn);
    }
    if (!lv_obj_has_flag(item_lcd_retest_btn, LV_OBJ_FLAG_HIDDEN)) {
        lv_group_add_obj(encoder_group, item_lcd_retest_btn);
    }
}

void BackFactoryTestScreen()
{
    LoadPage(ui_ScreenFactoryTestScreen, 1);
    lv_group_focus_obj(ui_ItemObj[0]);
}
  

/**
 * @description: 裸板测试添加事件对象到事件组
 * @return {*}
 * @param {uint8_t} index
 */
static void FactoryTestChangeObjs(uint8_t index)
{
    ...
    lv_group_remove_all_objs(encoder_group);
    PageNode *Machine_node = find_page(ui_ScreenFactoryTestScreen);
    Machine_node->nav_level = index;

    switch (index)
    {
    case 1:
        lv_group_add_obj(encoder_group, ui_factory_return_btn);
        lv_group_add_obj(encoder_group, ui_factory_auto_test_sw);
        for (int i = 0; i < ITEM_NUM; i++)
        {
            lv_group_add_obj(encoder_group, ui_ItemObj[i]);
        }
        break;
    case 2: // LCD测试事件对象
        FactoryLcdTestAddObjToGroup();
        break;
    case 3: // 触摸测试事件对象
       // FactoryTouchTestAddObjToGroup();
        break;
    case 4: // GPIO 接口功能事件
        lv_group_add_obj(encoder_group, item_gpio_btn0);
        lv_group_add_obj(encoder_group, item_gpio_btn4);
        lv_group_add_obj(encoder_group, item_gpio_btn2);
        lv_group_add_obj(encoder_group, item_gpio_btn1);
        lv_group_add_obj(encoder_group, item_gpio_btn5);
        lv_group_add_obj(encoder_group, item_gpio_btn3);
        lv_group_add_obj(encoder_group, item_gpio_return_btn);
        lv_group_add_obj(encoder_group, item_gpio_pass_btn);
        break;
    case 5: // ADC接口事件
        lv_group_add_obj(encoder_group, item_adc_return_btn);
        lv_group_add_obj(encoder_group, item_adc_pass_btn);
        break;
    case 6: // USB接口功能事件
        lv_group_add_obj(encoder_group, item_usb_return_btn);
        lv_group_add_obj(encoder_group, item_usb_retest_btn);
        lv_group_add_obj(encoder_group, item_usb_pass_btn);
        break;
    case 7: // MCU 通信接口事件
        lv_group_add_obj(encoder_group, item_mcu_return_btn);
        lv_group_add_obj(encoder_group, item_mcu_pass_btn);
        break;
    case 8: // 电机接口功能事件
        lv_group_add_obj(encoder_group, item_motor_x_btn);
        lv_group_add_obj(encoder_group, item_motor_y_btn);
        lv_group_add_obj(encoder_group, item_motor_z_btn);
        lv_group_add_obj(encoder_group, item_motor_e_btn);
        lv_group_add_obj(encoder_group, item_motor_return_btn);
        lv_group_add_obj(encoder_group, item_motor_pass_btn);
        break;
    case 9: // 有线网口事件
        lv_group_add_obj(encoder_group, item_touch_return_net);
        lv_group_add_obj(encoder_group, item_touch_pass_net);
     
        break;
    case 10: // 蜂鸣器接口事件
        lv_group_add_obj(encoder_group, item_paly_buzzer);
        lv_group_add_obj(encoder_group, item_touch_return_buzzer);
        lv_group_add_obj(encoder_group, item_touch_pass_buzzer);
        break;
    case 11: // 系统版本事件
        lv_group_add_obj(encoder_group, item_touch_return_version);
        lv_group_add_obj(encoder_group, item_touch_pass_version);
        break;
    default:
        break;
    }
