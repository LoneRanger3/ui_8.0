    ...
    switch(flag)
    {
            ...
            if(*data == '1')      //本地文件
            {
                ...
                if(*data == '0')
                {
                    ...
                    if(print_total_files)
                    {
                        ...
                        switch(UIType)
                        {
                            ...
                            case CR_K1:
                            case CR_K1_Max:set_files_count(print_total_files);break;
                        }
                    }
                    else
                    {
                        ...
                        {
                            case CR_K1:
                            case CR_K1_Max:set_files_count(0);break;
                        }
                    }
                ...
                else if(*data == '1')
                {
                    if(*(data+1) == '\t')
                    {
                        ...
                        switch(UIType)
                        {
                            ...
                            case CR_K1: 
                            case CR_K1_Max:analyze_files_info_respone(data, len); break;
                        }                        
                    }
                }
                else if(*data == '2')
                {
                    ...
                    switch(UIType)
                    {
                        ...
                        case CR_K1:
                        case CR_K1_Max:analyze_filling_chart_info_respone(data,len-3); break;
                    }      
                }
                else if(*data == '3')
                {
                    ...
                    switch(UIType)
                    {
                        ...
                        case CR_K1: 
                        case CR_K1_Max:set_powerloss_recovery_info(atoi(state)); break;
                    }      
                }
                else if(*data == '5')
                {
                ...
                else if(*data == '6')
                {
                    ...
                    switch(UIType)
                    {
                        case CR_10_H1:break;
                        case CR_K1:
                        case CR_K1_Max:refresh_prepare_process(process);break;
                    } 
            ...
            else if(*data == '2')      //打印历史记录
            {
                ...
                if(*data == '0')
                {
                    ...
                    if(history_total_files)
                    {
                        ...
                        switch(UIType)
                        {
                            ...
                            case CR_K1:
                            case CR_K1_Max:set_print_record_count(history_total_files); break;
                        }  
                    }
                    else
                    {
                        ...
                        {
                            case CR_K1: 
                            case CR_K1_Max:set_print_record_count(0); break;
                        }
                    }
                }
                else if(*data == '1')
                {
                    ...
                    switch(UIType)
                    {
                        ...
                        case CR_K1: 
                        case CR_K1_Max:analyze_print_records_info_respone(data, len); break;
                    }
                }
                else if(*data == '2')
                {
                    ...
                    if(history_info.filename)
                    {
                        switch(UIType)
                        {
                            case CR_10_H1:break;
                            case CR_K1: 
                            case CR_K1_Max:FromHistoryToPreview(true,history_info); break;
                        }
                    }
                    else
                    {
                        switch(UIType)
                        {
                            case CR_10_H1:break;
                            case CR_K1: 
                            case CR_K1_Max:FromHistoryToPreview(false,history_info); break;
                        }
                    }
                }
            }
            else if(*data == '3')      //视频列表
            {
                ...
                if(*data == '0')
                {
                    ...
                    if(videolist_total_files)
                    {
                        ...
                        switch(UIType)
                        {
                            ...
                            case CR_K1:
                            case CR_K1_Max:set_vedioes_count(videolist_total_files); break;
                        }
                    }
                    else
                    {
                ...
                else if(*data == '1')
                {
                    ...
                    switch(UIType)
                    {
                        ...
                        case CR_K1:
                        case CR_K1_Max:analyze_vedioes_info_respone(data, len);break;
                    }
                }
            }
            break; 
        ...
        case CONTROL_Z_AXIS_OFFSET:  //0x02：获取打印机的Z轴偏移数据
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1: 
                case CR_K1_Max:set_offset_z(atof(zoffset_value)); expert_set_offset_z(atof(zoffset_value));break;
            }
            break;            
        }
        case CONTROL_HOT_BED_TEMP:  //0x03：获取当前喷头和热床温度
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1_Max:{
                    ...
                    refresh_expert_bedpid_page();
                    refresh_expert_hotpid_page();
                    // 刷新产测数据
                    if (isFactoryTest()) {
        ...
        case CONTROL_PARAMETERS:
        {
            ...
            else if(*data == '1')   //获取当前照明状态
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1: 
                    case CR_K1_Max:set_light_status(light_state); break;
                }
            }
            ...
            else if(*data == 'b')   //获取屏幕保护状态
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:refresh_screenoff_setting(atoi(screen_save_value));break;
                }
            }
            ...
            else if(*data == 'e')   //获取屏幕亮度值
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:refresh_light_value(system_state.light_value);break;
                }
            }
            ...
            else if(*data == 'l')   //获取静音模式状态
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:change_silentmode_print(system_state.FilamentSensor_state);
                                   change_silentmode_normal(system_state.FilamentSensor_state);
                                   break;
                }
            }
            else if(*data == 'm')
            {
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_timezoneseting(data+1);break;
                }
            }
            else if(*data == 'n')
            {
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_serverinfo_page(atoi(data+1));break;
                }
            }
            else if(*data == 'o')
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_checkupdateflag_state(atoi(data+1));break;
                }
            }
            else if(*data == 'p')
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:ChangeServerOption(init_uiconfiginfo.ServerOption);
            ...
            else if(*data == 's')
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refreshSharePictrueState(system_state.IsAgreeSharePicture);break;
                }
            }
            break;            
        }
        ...
        case CONTROL_FILAMENT:
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:refresh_filament_process(flag, process);
                    break;
            }
            break;
        }
...
//                refresh_auto_level_hspeed();
            ...
            else if(*data == '8')
            {
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:refresh_BedMesh_point(len, data);break;
                }
            }
            break;            
        }
...
//            break;
        ...
        case CONTROL_PRINT_STATE:  //0x0f：获取打印时间和打印进度
        {
            ...
            {
                data++;
                print_state = atoi(data);
                CrLogI("the print_state change:%d",print_state);
                switch(UIType)
                {
                    case CR_10_H1:refresh_print_state();break;
                    case CR_K1:
                    case CR_K1_Max:set_printing_status(print_state);break;
                }
                break;
            }
        ...
        case CONTROL_PRINT_SPEED:  //0x10：获取打印速度
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:set_speed_percent(atoi(cur_speed)); break;
            }
            break;
        }
           ...
           if(len)
           {
               ...
               //refresh_language();
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:set_cur_language(cur_language); break;
                }
           }
           break;
...
//            break;
        case CONTROL_MACHINE_PARAMETERS:  //0x14：获取关于本机页面的所有参数
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:refresh_aboutdevice_page(machineinfo);set_versioninfo_settingpage(screen_ver_value);break;
            }
            break;            
        }
            ...
            if(len > 2)  //新的二维码命令改变了
            {
                ...
                else if ( *data == '2' )  //客服意见反馈二维码
                {
                    ...
                    switch(UIType)
                    {
                        case CR_10_H1:break;
                        case CR_K1:
                        case CR_K1_Max:set_faq_qrcode(faq_qrcode);break;
                    }
                }
        ...
        case CONTROL_PRINT_FLOW:
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:set_flow_percent(atoi(cur_printflow)); expert_set_traffic_percent(atoi(cur_printflow));break;
            }
        ...
        case CONTROL_ERROR_MSG:
        {
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:set_error_msg(atoi(errorcode), atoi(k1_errorcode), (data+i+1)) ;break;
            }
            break;
        }
        case CONTROL_UPDATE_MSG:
        {
            if(*data == '0')    //升级进度及升级状态解析
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:RefreshUpdateVersionProgress(version_flag,upgrade_progress);break;
                }
            }
            else //版本信息查询
            {
        ...
        case CONTROL_MACHINE_STATE:  //启用全屏或者息屏
        {
            if(*data == '1') //启动全屏
            {
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:break;//set_full_screen_display_status(true); 
                }
            }
            else if(*data == '2') //启动熄屏
            {
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:set_screen_off_status(true); break;
                }
            }
            else if(*data == '4') //U盘状态
            {
            ...
            else if(*data == '5') //摄像头状态
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:hoem_page_refresh_camerastate(system_state.Camera_model_state);
                                   print_page_refresh_camerastate(system_state.Camera_model_state);
            ...
            else if(*data == '6') //创想云绑定状态
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max: refresh_DeviceUserInfo(result, cxyUserinfo);
                                    selftest_check_cxyuserinfo(result);
                                    refresh_DeviceUserInfo_selftest(cxyUserinfo);
                                    break;
                    default:break;
                }
            }
            else if(*data == '7') //Klipper状态
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max: //暂时未定义断开后的重连流程，目前只在开机检查状态
                    {
            ...
            else if(*data == 'c') //对象排除
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refreshExcludeObjectPage(data);break;
                }
            } 
            break;
        }
        ...
        case CONTROL_CAMERA_OPTIONS:
        {
            if(*data == '1') //延时摄影状态
            {
                ...
                {
                    case CR_K1:
                    case CR_K1_Max:set_camera_delayed_photography(isopencamera); break;
                }
            }
            else if(*data == '2') //延时摄影喷嘴位置
            {
                ...
                {
                    case CR_K1:
                    case CR_K1_Max:set_camera_shoot_pos(pos); break;
                }
            }
            else if(*data == '3') //拍照层数
            {
                ...
                {
                    case CR_K1:
                    case CR_K1_Max:set_camera_shoot_freq(atoi(picturelayers)); break;
                }
            }
            else if(*data == '4') //渲染方式
            {
                ...
                {
                    case CR_K1: 
                    case CR_K1_Max:set_camera_rendering_method(atoi(Render_mode)); break;
                }
            }
            switch(UIType)
            {
        ...
        case CONTROL_AI_OPTIONS:
        {
            if(*data == '1') //AI参数设置
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:
                    case CR_K1:
                    case CR_K1_Max:set_ai_detection_state(ai_state); break;
                }
            }
            break;
        }
        case CONTROL_XYZ_AXIS_RANGE:
        {
            if(*data == '1') //xyz轴最大移动范围
            {
                ...
                system_state.Y_Axis_Min = atoi(ymin);
                system_state.Y_Axis_Max = atoi(ymax);
                system_state.Z_Axis_Min = atoi(zmin);
                system_state.Z_Axis_Max = atoi(zmax);
                CrLogI("xyz axis range:%d, %d, %d, %d, %d, %d",system_state.X_Axis_Min,system_state.X_Axis_Max,
                system_state.Y_Axis_Max,system_state.Y_Axis_Max,system_state.Z_Axis_Max,system_state.Z_Axis_Max);
                switch(UIType)
                {
                    case CR_10_H1:
                    case CR_K1:
    ...
    switch(flag)
    {
        case CONTROL_FILE:{
            ...
            if(*data == '1')
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:refresh_copyprocess(atoi(process),atoi(num));break;
                }
            }
            if(*data == '2')
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:create_tips(atoi(message));
                    break;
                }
            }
            if(*data == '3')
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_export_video_process(atoi(process));break;
                }
            }
            break;            
        }
        ...
        case CONTROL_XYZ_AXIS:{
            ...
            switch(UIType)
            {
                case CR_10_H1:;break;
                case CR_K1:
                case CR_K1_Max:set_homing_status(*(data + 1));
...
//                }
            ...
            else if(*(data) == '6')   //接收喷头或热床PID返回的进度数据
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:{refresh_expert_bedpid_page();refresh_expert_hotpid_page();
                        break;
                    }
                }
            }
...
//            }
        ...
        case CONTROL_LANGUAGE:{
            ...
            switch(UIType)
            {
                ...
                case CR_K1:
                case CR_K1_Max:change_language_end(cur_language);break;
            }
            break;        
        }
        ...
        case CONTROL_MACHINE_STATE:{
            ...
            else if(*data == '6')//解绑创想云
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:get_printer_data(CONTROL_MACHINE_STATE, 2, "6"); //无论成功失败都再查询一次用户信息
                        break;
                }
            }
            else if(*data == 'a')//AI轮廓仪标定
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:break;
                    case CR_K1_Max:JudgeAILiDARIsNormal(*(data+1) - '0');break;
                }
            }
            break;
        }
        case CONTROL_MACHINE_LOG:{
            if(*data == '1')
            {
                ...
                switch(UIType)
                {
                    ...
                    case CR_K1:
                    case CR_K1_Max:refreshmsgbox(type, process);break;
                }
            }
            else if(*data == '2')//上传日志
            {
                ...
                switch (UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_uploadlog_process(state, process, SN);
            ...
            else if(*data == '4')//压缩状态
            {
                ...
                switch(UIType)
                {
                    case CR_10_H1:break;
                    case CR_K1:
                    case CR_K1_Max:refresh_compressed_process(process);break;
                }
