...
void ui_laser_test_init(lv_obj_t* parents) 
{
    ...
    lv_obj_set_size(laser_obj,800,480);
    ...
    lv_obj_align_to(laser_prevStep_btn, laser_obj, LV_ALIGN_BOTTOM_LEFT, 10, -40);
    ...
    lv_obj_align_to(laser_step1_start_btn, laser_obj, LV_ALIGN_BOTTOM_MID, 0, -40);
    ...
    lv_obj_align_to(laser_step2_start_btn, laser_obj, LV_ALIGN_BOTTOM_MID, 0, -40);
    ...
    laser_step_label = add_label(laser_obj, step1Text, lv_font25.font, lv_color_white(),
                                    LV_ALIGN_BOTTOM_MID, laser_obj, 0, -140);
    lv_obj_add_flag(laser_step2_start_btn,LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_align_to(return_btn, laser_obj, LV_ALIGN_LEFT_MID, 10, 95);
    ...
    lv_obj_align_to(laser_sw_btn, laser_obj, LV_ALIGN_RIGHT_MID, -170, 95);
    ...
    hotend_label = add_label(laser_obj, nozzleTempText, lv_font25.font, lv_color_white(),
                                        LV_ALIGN_BOTTOM_MID, laser_obj, -200, -90);
