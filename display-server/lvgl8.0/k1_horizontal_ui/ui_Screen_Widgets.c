 ...
 * @LastEditTime: 2023-03-18 14:34:08
 */
#include "ui.h"
...
//弹窗
lv_obj_t * ui_SelftestAutolevelMsgboxBg;
lv_obj_t * ui_SelftestAutolevelMsgbox;
...
void init_msgbox()
{
    ...
    lv_obj_set_width(ui_Msgbox, 800);
    ...
    lv_obj_set_style_bg_opa(ui_Msgbox, 180, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_align(ui_Msgboximg, LV_ALIGN_LEFT_MID, 20, 0);
...
void create_msgbox(char * title, char * imgsrc, uint32_t continue_length, lv_obj_t * parent)
{
    ...
    if(title != NULL)
    {
        ...
        redefine_label_size(ui_MsgboxTitle, lv_font25.font, 0, 0, 420, 0);

        lv_obj_update_layout(ui_Msgboxbg);
        redefine_widgets_size(ui_Msgboxbg, ui_MsgboxTitle, 5, 0, 480, 70);
    }
...
ErrorMsg_t * Error_message_create(char * title, char * content, char * btn1, char *btn2, int errorcode, char * error_content)
{
    ...
    lv_obj_set_width(ErrorMsgbox, 800);
    ...
    lv_obj_set_style_text_font(MsgboxTitle, lv_font25.font, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_t * MsgboxContent = lv_label_create(ErrorMsgboxbg);
    lv_obj_set_width(MsgboxContent, 630);
    lv_obj_set_height(MsgboxContent, 60);
    ...
    lv_obj_t * ErrorMsgboxlabel1 = lv_label_create(ErrorMsgboxbg);
    ...
    lv_obj_t * ErrorMsgboxlabel2 = lv_label_create(ErrorMsgboxbg);
...
void ui_event_msgbtn1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        ...
        if(current_error)   //当前是错误类型弹窗
        {
            ...
            void (*btns_callback[2])(void) = {&error_btn1, &error_btn2};
            create_selftest_messagebox(Warning[index], content, Restart[index], UploadErrorTips2[index], btns_callback);
            Error_message_delete(user_data);
        }
...
void wifi_wait_animmotion(bool flag)
{
    if (ui_WifiwaitAnimotion == NULL)
    {
        ...
        ui_waitimg = lv_gif_create(ui_WifiwaitAnimotion);
        lv_obj_set_width(ui_waitimg, LV_SIZE_CONTENT);
        lv_obj_set_height(ui_waitimg, LV_SIZE_CONTENT);
        lv_obj_set_align(ui_waitimg, LV_ALIGN_CENTER);
...
void create_wificonect_page(lv_obj_t * screen_page, const char * wifiname, bool isHiddenNetwork)
{
    ...
    lv_obj_set_parent(ui_NetworkSettingPanel6, screen_page);
    lv_textarea_set_text(ui_NetworkSettingLabel3, wifiname);
    if(isHiddenNetwork)
    {
        lv_obj_add_flag(ui_NetworkSettingLabel3, LV_OBJ_FLAG_CLICKABLE);
        if(!lv_obj_has_state(ui_NetworkSettingLabel3, LV_STATE_FOCUSED))
            lv_obj_add_state(ui_NetworkSettingLabel3, LV_STATE_FOCUSED);
    }
    else
    {
        lv_obj_clear_flag(ui_NetworkSettingLabel3, LV_OBJ_FLAG_CLICKABLE);
        if(!lv_obj_has_state(ui_NetworkSetting_TextArea1, LV_STATE_FOCUSED))
            lv_obj_add_state(ui_NetworkSetting_TextArea1, LV_STATE_FOCUSED);
    }
    lv_textarea_set_text(ui_NetworkSetting_TextArea1,"");
    lv_obj_clear_flag(ui_NetworkSettingPanel6, LV_OBJ_FLAG_HIDDEN);
}
/***********wifi网络连接页面及接口**************/
...
void PrivacyMsgbox_event_handler(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        ...
        else if(target == lv_obj_get_child(child, 2))//btn1
        {
            lv_obj_del(userdata);
        }
        else if(target == lv_obj_get_child(child, 3))//btn2
        {
...
{
    uint8_t language_index = get_cur_language_index();
    lv_obj_t * PrivacyMessagebox = lv_obj_create(lv_layer_top());
    ...
    lv_obj_set_width(PrivacyMsgboxlabel2, 400);
    lv_obj_set_height(PrivacyMsgboxlabel2, 172);
    ...
    lv_obj_set_x(PrivacyMsgboxButton1, 28);
    ...
    lv_obj_t * PrivacyMsgboxButton2 = lv_btn_create(PrivacyMessagecontent);
    lv_obj_set_width(PrivacyMsgboxButton2, 146);
    lv_obj_set_height(PrivacyMsgboxButton2, 60);
    lv_obj_set_x(PrivacyMsgboxButton2, 244);
    lv_obj_set_y(PrivacyMsgboxButton2, 220);
...
{
    if(ui_SelftestAutolevelMsgboxBg == NULL)
    {
        uint8_t language_index = get_cur_language_index();
        ui_SelftestAutolevelMsgboxBg = lv_obj_create(lv_layer_top());
        lv_obj_set_width(ui_SelftestAutolevelMsgboxBg, 800);
        lv_obj_set_height(ui_SelftestAutolevelMsgboxBg, 480);
        lv_obj_clear_flag(ui_SelftestAutolevelMsgboxBg, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
        lv_obj_set_style_radius(ui_SelftestAutolevelMsgboxBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_color(ui_SelftestAutolevelMsgboxBg, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_opa(ui_SelftestAutolevelMsgboxBg, 180, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_border_width(ui_SelftestAutolevelMsgboxBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_all(ui_SelftestAutolevelMsgboxBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_add_flag(lv_layer_top(), LV_OBJ_FLAG_CLICKABLE);

        ui_SelftestAutolevelMsgbox = lv_obj_create(ui_SelftestAutolevelMsgboxBg);
        lv_obj_set_width(ui_SelftestAutolevelMsgbox, 418);
        lv_obj_set_height(ui_SelftestAutolevelMsgbox, 300);
        lv_obj_set_x(ui_SelftestAutolevelMsgbox, 191);
        lv_obj_set_y(ui_SelftestAutolevelMsgbox, 79);
        lv_obj_clear_flag(ui_SelftestAutolevelMsgbox, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
        lv_obj_set_style_radius(ui_SelftestAutolevelMsgbox, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_color(ui_SelftestAutolevelMsgbox, lv_color_hex(0x29292C), LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_opa(ui_SelftestAutolevelMsgbox, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_border_width(ui_SelftestAutolevelMsgbox, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_left(ui_SelftestAutolevelMsgbox, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_right(ui_SelftestAutolevelMsgbox, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_top(ui_SelftestAutolevelMsgbox, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_bottom(ui_SelftestAutolevelMsgbox, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

        ui_Msgboxlabel1 = lv_label_create(ui_SelftestAutolevelMsgbox);
        ...
        lv_obj_set_y(ui_Msgboxlabel1, 20);
        ...
        lv_obj_set_style_text_color(ui_Msgboxlabel1, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        lv_obj_set_style_text_font(ui_Msgboxlabel1, lv_font24.font, LV_PART_MAIN | LV_STATE_DEFAULT);

        ui_Msgboxlabel2 = lv_label_create(ui_SelftestAutolevelMsgbox);
        lv_obj_set_width(ui_Msgboxlabel2, 338);
        lv_obj_set_height(ui_Msgboxlabel2, 172);
        lv_obj_set_x(ui_Msgboxlabel2, 40);
        lv_obj_set_y(ui_Msgboxlabel2, 92);
        lv_label_set_long_mode(ui_Msgboxlabel2, LV_LABEL_LONG_WRAP);
        lv_label_set_recolor(ui_Msgboxlabel2, true);
        ...
        ui_MsgboxButton1 = lv_btn_create(ui_SelftestAutolevelMsgbox);
        lv_obj_set_width(ui_MsgboxButton1, 146);
        lv_obj_set_height(ui_MsgboxButton1, 60);
        lv_obj_set_x(ui_MsgboxButton1, 28);
        lv_obj_set_y(ui_MsgboxButton1, 220);
        ...
        ui_MsgboxButton2 = lv_btn_create(ui_SelftestAutolevelMsgbox);
        lv_obj_set_width(ui_MsgboxButton2, 146);
        lv_obj_set_height(ui_MsgboxButton2, 60);
        lv_obj_set_x(ui_MsgboxButton2, 244);
        lv_obj_set_y(ui_MsgboxButton2, 220);
        ...
        lv_label_set_text(ui_MsgboxBtnlabel2, "");
    ...
    {
        if(lv_obj_has_flag(ui_SelftestAutolevelMsgboxBg,LV_OBJ_FLAG_HIDDEN))
        {
            lv_obj_add_flag(lv_layer_top(), LV_OBJ_FLAG_CLICKABLE);
            lv_obj_clear_flag(ui_SelftestAutolevelMsgboxBg, LV_OBJ_FLAG_HIDDEN);     /// Flags  
    ...
    {
        lv_obj_align(ui_MsgboxButton1,LV_ALIGN_TOP_LEFT,28,220);
        lv_obj_align(ui_MsgboxButton2,LV_ALIGN_TOP_LEFT,224,220);
    }
    if ( ui_MsgboxBtnlabel1 )
    {
        if ( btn1label && strlen(btn1label) )
        {
            ...
            redefine_label_size(ui_MsgboxBtnlabel1, lv_font24.font, 0, 0, 146, 0);
            lv_obj_update_layout(ui_MsgboxButton1);

            redefine_widgets_size(ui_MsgboxButton1, ui_MsgboxBtnlabel1, 2, 0, 146, 60);
        }
        else 
        {
            lv_obj_add_flag(ui_MsgboxButton1, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    if ( ui_MsgboxBtnlabel2 )
    {
        if ( btn2label && strlen(btn2label) )
        {
            ...
            redefine_label_size(ui_MsgboxBtnlabel2, lv_font24.font, 0, 0, 146, 0);
            lv_obj_update_layout(ui_MsgboxButton2);

            redefine_widgets_size(ui_MsgboxButton2, ui_MsgboxBtnlabel2, 2, 0, 146, 60);
        }
        else
        {
...
{
    lv_obj_add_flag(ui_SelftestAutolevelMsgboxBg, LV_OBJ_FLAG_HIDDEN);
    lv_obj_clear_flag(lv_layer_top(), LV_OBJ_FLAG_CLICKABLE);
}
