        ...
        case LV_EVENT_CLICKED:
        {
            ...
            switch(input_char)
            {
                ...
                case 'E':
                {
                    ...
                    len = 0;
                    lv_obj_del(numbers_keys_panel);
                    numbers_keys_panel = NULL;
                    break;
                }
                case 'O':
                {
...
void numberskeyboardinput(char *msg, int inputmax, int inputmin, void (*confirm_btn_call_back)(void *), void (*key_reminder)(int), uint16_t pos_x, uint16_t pos_y)
{
    /*******************init style*******************************/
    /*****************************create number keys************************/
        lv_obj_t * ui_ScreenNumberKeysPanelBg;
        ...
        ui_ScreenNumberKeysPanelBg = lv_obj_create(lv_scr_act());
        lv_obj_set_width(ui_ScreenNumberKeysPanelBg, 800);
        lv_obj_set_height(ui_ScreenNumberKeysPanelBg, 480);
        lv_obj_clear_flag(ui_ScreenNumberKeysPanelBg, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
        lv_obj_set_style_radius(ui_ScreenNumberKeysPanelBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_color(ui_ScreenNumberKeysPanelBg, lv_color_hex(0x050505), LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_opa(ui_ScreenNumberKeysPanelBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_border_width(ui_ScreenNumberKeysPanelBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_pad_all(ui_ScreenNumberKeysPanelBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        numbers_keys_panel = ui_ScreenNumberKeysPanelBg;

        ui_ScreenNumberKeysPanel = lv_obj_create(ui_ScreenNumberKeysPanelBg);
    ...
    /****************************************************/
    lv_obj_set_x(ui_ScreenNumberKeysPanel, pos_x);
    lv_obj_set_y(ui_ScreenNumberKeysPanel, pos_y);
