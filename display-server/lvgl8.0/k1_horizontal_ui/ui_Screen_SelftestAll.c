...
lv_obj_t *Msgbox1Bg;
lv_obj_t *Msgbox1;
lv_obj_t *Msgboxlabel1;
lv_obj_t *Msgboxlabel2;
lv_obj_t *MsgboxBtn1;
lv_obj_t *MsgboxBtn2;
...
bool HasMsgboxFlag = false;         //存在自检已完成的弹窗
...
void style_init(void)
{
    ...
    lv_style_set_text_font(&test_label_default, lv_font25.font);
...
void ui_SelftestAll_screen_init(void)
{
    ...
    lv_obj_set_align(ui_SelftestAlltitle, LV_ALIGN_TOP_MID);
    ...
    lv_obj_set_width(ui_SelftestAll_Panel2, 455);
    lv_obj_set_height(ui_SelftestAll_Panel2, 398);
    lv_obj_set_x(ui_SelftestAll_Panel2, 330);
    lv_obj_set_y(ui_SelftestAll_Panel2, 64);
    ...
    lv_obj_set_style_bg_color(ui_SelftestAll_Panel2, lv_color_hex(0x1C1C1E), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_SelftestAll_test1, 455);
    lv_obj_set_height(ui_SelftestAll_test1, 55);

    lv_obj_set_width(ui_SelftestAll_test2, 455);
    lv_obj_set_height(ui_SelftestAll_test2, 55);

    lv_obj_set_width(ui_SelftestAll_test3, 455);
    lv_obj_set_height(ui_SelftestAll_test3, 55);

    lv_obj_set_width(ui_SelftestAll_test4, 455);
    lv_obj_set_height(ui_SelftestAll_test4, 55);

    lv_obj_set_width(ui_SelftestAll_test5, 455);
    lv_obj_set_height(ui_SelftestAll_test5, 55);

    lv_obj_set_width(ui_SelftestAll_test6, 455);
    lv_obj_set_height(ui_SelftestAll_test6, 55);
    ...
    //设置样式及名称
    //项目1
    lv_obj_set_width(ui_test1_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test1_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test1_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    lv_obj_align(ui_test1_checking, LV_ALIGN_RIGHT_MID, -35, 0);
    char gifsrc[256] = {0};
    snprintf(gifsrc, 256, "S:%s/%s", GetK1ImageResourcePtah(), "checking.gif");
    lv_gif_set_src(ui_test1_checking, gifsrc);

    lv_obj_set_width(ui_test1_resultimg, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test1_resultimg, LV_SIZE_CONTENT);
    lv_obj_align(ui_test1_resultimg, LV_ALIGN_RIGHT_MID, -35, 0);
    ...
    //项目2
    lv_obj_set_width(ui_test2_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test2_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test2_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    //项目3
    lv_obj_set_width(ui_test3_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test3_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test3_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    lv_obj_set_style_text_line_space(ui_test3_name, -6, LV_PART_MAIN|LV_STATE_DEFAULT);

    lv_obj_set_width(ui_test3_checking, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test3_checking, LV_SIZE_CONTENT);
    lv_obj_align(ui_test3_checking, LV_ALIGN_RIGHT_MID, -35, 0);
    ...
    //项目4
    lv_obj_set_width(ui_test4_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test4_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test4_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    lv_obj_set_style_text_line_space(ui_test4_name, -6, LV_PART_MAIN|LV_STATE_DEFAULT);

    lv_obj_set_width(ui_test4_checking, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test4_checking, LV_SIZE_CONTENT);
    lv_obj_align(ui_test4_checking, LV_ALIGN_RIGHT_MID, -35, 0);
    ...
    lv_obj_set_width(ui_test5_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test5_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test5_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    lv_obj_align(ui_test5_checking, LV_ALIGN_RIGHT_MID, -35, 0);
    ...
    lv_obj_set_width(ui_test6_name, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_test6_name, LV_SIZE_CONTENT);
    lv_obj_align(ui_test6_name, LV_ALIGN_LEFT_MID, 10, 0);
    ...
    lv_obj_align(ui_test6_checking, LV_ALIGN_RIGHT_MID, -35, 0);
    ...
    lv_obj_set_width(Msgbox1Bg, 800);
    lv_obj_set_height(Msgbox1Bg, 480);
    lv_obj_set_x(Msgbox1Bg, 0);
    lv_obj_set_y(Msgbox1Bg, 0);
    ...
    lv_obj_set_width(Msgbox1, 418);
    lv_obj_set_height(Msgbox1, 300);
    lv_obj_set_x(Msgbox1, 191);
    lv_obj_set_y(Msgbox1, 79);
    ...
    Msgboxlabel1 = lv_label_create(Msgbox1);
    lv_obj_set_width(Msgboxlabel1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(Msgboxlabel1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(Msgboxlabel1, 0);
    lv_obj_set_y(Msgboxlabel1, 20);
    lv_obj_set_align(Msgboxlabel1, LV_ALIGN_TOP_MID);
    lv_label_set_long_mode(Msgboxlabel1, LV_LABEL_LONG_SCROLL);
    lv_label_set_text(Msgboxlabel1, KindTips[language_index]);
    lv_obj_set_style_text_color(Msgboxlabel1, lv_color_hex(0x42BDD8), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(Msgboxlabel1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(Msgboxlabel1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(Msgboxlabel1, lv_font24.font, LV_PART_MAIN | LV_STATE_DEFAULT);

    Msgboxlabel2 = lv_label_create(Msgbox1);
    lv_obj_set_width(Msgboxlabel2, 338);
    lv_obj_set_height(Msgboxlabel2, 172);
    lv_obj_set_x(Msgboxlabel2, 40);
    lv_obj_set_y(Msgboxlabel2, 72);
    lv_label_set_long_mode(Msgboxlabel2, LV_LABEL_LONG_DOT);
    lv_label_set_text(Msgboxlabel2, "");
    ...
    lv_obj_set_style_text_align(Msgboxlabel2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(Msgboxlabel2, lv_font24.font, LV_PART_MAIN | LV_STATE_DEFAULT);

    MsgboxBtn1 = lv_btn_create(Msgbox1);
    lv_obj_set_width(MsgboxBtn1, 146);
    lv_obj_set_height(MsgboxBtn1, 60);
    lv_obj_set_x(MsgboxBtn1, 28);
    lv_obj_set_y(MsgboxBtn1, 220);
    ...
    lv_obj_set_width(MsgboxBtnlabel1, LV_SIZE_CONTENT);   /// 1
    ...
    lv_obj_set_width(MsgboxBtn2, 146);
    lv_obj_set_height(MsgboxBtn2, 60);
    lv_obj_set_x(MsgboxBtn2, 244);
    lv_obj_set_y(MsgboxBtn2, 220);
...
void show_msgbox1(int flag)
{
    ...
    switch (flag)
    {
    case 1:lv_label_set_text(Msgboxlabel2, Error1[get_cur_language_index()]);break;
    case 2:lv_label_set_text(Msgboxlabel2, Error2[get_cur_language_index()]);break;
    case 3:lv_label_set_text(Msgboxlabel2, Error3[get_cur_language_index()]);break;
    case 4:lv_label_set_text(Msgboxlabel2, Error4[get_cur_language_index()]);break;
    case 5:lv_label_set_text(Msgboxlabel2, Error5[get_cur_language_index()]);break;
    case 6:lv_label_set_text(Msgboxlabel2, Error6[get_cur_language_index()]);break;
    case 7:lv_label_set_text(Msgboxlabel2, Error7[get_cur_language_index()]);break;
    // case 8:lv_label_set_text(Msgboxlabel2, Error8[get_cur_language_index()]);break;
    default:
        break;
    }
...
void self_test_all_change_language_text(void)
{
    ...
    lv_label_set_text(Msgboxlabel1, KindTips[language_index]);
    lv_label_set_text(MsgboxBtnlabel1, UploadErrorTips2[get_cur_language_index()]);//Cancel[language_index]
    redefine_label_size(MsgboxBtnlabel1, lv_font24.font, 0, 0, 220, 0);

    lv_obj_update_layout(MsgboxBtn1);
    redefine_widgets_size(MsgboxBtn1, MsgboxBtnlabel1, 5, 0, 146, 60);
    lv_label_set_text(MsgboxBtnlabel2, ErrorBtnConfirm[language_index]);
}
