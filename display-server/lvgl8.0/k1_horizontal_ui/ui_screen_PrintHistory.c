...
static lv_obj_t * ui_ImgLocalLeftHistoryPage;
static lv_obj_t * ui_ImgLocalRightHistoryPage;
static lv_obj_t * ui_ButtonLocalFileScreenHistory;
static lv_obj_t * ui_LabelLocalScreenHistory;
static lv_obj_t * ui_ImgUsbLeftHistoryPage;
static lv_obj_t * ui_ImgUsbRightHistoryPage;
static lv_obj_t * ui_ButtonUsbFileScreenHistory;
static lv_obj_t * ui_LabelUDiskScreenHistory;
static lv_obj_t * ui_ImgHistoryLeftHistoryPage;
static lv_obj_t * ui_ImgHistoryRightHistoryPage;
...
void ui_ScreenPrintHistory_screen_init(void)
{
    ...
    lv_obj_set_width(ui_PanelPageScreenHistory, 80);
    lv_obj_set_height(ui_PanelPageScreenHistory, 480);
    ...
    lv_obj_set_width(ui_ButtonHomeScreenHistory, 80);
    lv_obj_set_height(ui_ButtonHomeScreenHistory, 96);
    lv_obj_set_x(ui_ButtonHomeScreenHistory, -22);
    lv_obj_set_y(ui_ButtonHomeScreenHistory, -22);
    ...
    lv_obj_set_width(ui_ButtonAxisMoveScreenHistory, 80);
    lv_obj_set_height(ui_ButtonAxisMoveScreenHistory, 96);
    lv_obj_set_x(ui_ButtonAxisMoveScreenHistory, -22);
    lv_obj_set_y(ui_ButtonAxisMoveScreenHistory, 74);
    ...
    lv_obj_set_width(ui_ImageFileManageScreenHistory, 80);
    lv_obj_set_height(ui_ImageFileManageScreenHistory, 96);
    lv_obj_set_x(ui_ImageFileManageScreenHistory, -22);
    lv_obj_set_y(ui_ImageFileManageScreenHistory, 170);
    ...
    lv_obj_set_width(ui_ButtonSettingsScreenHistory, 80);
    lv_obj_set_height(ui_ButtonSettingsScreenHistory, 96);
    lv_obj_set_x(ui_ButtonSettingsScreenHistory, -22);
    lv_obj_set_y(ui_ButtonSettingsScreenHistory, 266);
    ...
    lv_obj_set_width(ui_ButtonReserveScreenHistory, 80);
    lv_obj_set_height(ui_ButtonReserveScreenHistory, 96);
    lv_obj_set_x(ui_ButtonReserveScreenHistory, -22);
    lv_obj_set_y(ui_ButtonReserveScreenHistory, 362);
    ...
    lv_obj_set_width(ui_PanelFileOptScreenHistory, 720);
    lv_obj_set_height(ui_PanelFileOptScreenHistory, 50);
    lv_obj_set_x(ui_PanelFileOptScreenHistory, 80);
    lv_obj_set_y(ui_PanelFileOptScreenHistory, 0);
    ...
    lv_obj_set_style_bg_color(ui_PanelFileOptScreenHistory, lv_color_hex(0x121212), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_all(ui_PanelFileOptScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_PanelFileOptScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_PanelFileOptScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_flex_flow(ui_PanelFileOptScreenHistory, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(ui_PanelFileOptScreenHistory, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_END, LV_FLEX_ALIGN_END);
    lv_obj_set_style_pad_column(ui_PanelFileOptScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_ImgLocalLeftHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    char tempbuffb[256] = {0};
    snprintf(tempbuffb, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TilteLeftstyle.png");
    lv_img_set_src(ui_ImgLocalLeftHistoryPage, tempbuffb);
    lv_obj_set_width(ui_ImgLocalLeftHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgLocalLeftHistoryPage, LV_SIZE_CONTENT);

    ui_ButtonLocalFileScreenHistory = lv_btn_create(ui_PanelFileOptScreenHistory);
    lv_obj_set_width(ui_ButtonLocalFileScreenHistory, 161);
    lv_obj_set_height(ui_ButtonLocalFileScreenHistory, 46);
    lv_obj_set_style_radius(ui_ButtonLocalFileScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_ButtonLocalFileScreenHistory, lv_color_hex(0x121212), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_LabelLocalScreenHistory, 155);
    lv_obj_set_height(ui_LabelLocalScreenHistory, 35);
    lv_obj_align(ui_LabelLocalScreenHistory, LV_ALIGN_CENTER, 0, 0);
    ...
    ui_ImgLocalRightHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    char tempbuffa[256] = {0};
    snprintf(tempbuffa, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TitleRightstyle.png");
    lv_img_set_src(ui_ImgLocalRightHistoryPage, tempbuffa);
    lv_obj_set_width(ui_ImgLocalRightHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgLocalRightHistoryPage, LV_SIZE_CONTENT);

    ui_ImgUsbLeftHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    memset(tempbuffb, 256, 0);
    snprintf(tempbuffb, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TilteLeftstyle.png");
    lv_img_set_src(ui_ImgUsbLeftHistoryPage, tempbuffb);
    lv_obj_set_width(ui_ImgUsbLeftHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgUsbLeftHistoryPage, LV_SIZE_CONTENT);

    ui_ButtonUsbFileScreenHistory = lv_btn_create(ui_PanelFileOptScreenHistory);
    lv_obj_set_width(ui_ButtonUsbFileScreenHistory, 161);
    lv_obj_set_height(ui_ButtonUsbFileScreenHistory, 46);
    ...
    lv_obj_align(ui_LabelUDiskScreenHistory, LV_ALIGN_CENTER, 0, 0);
    lv_label_set_text(ui_LabelUDiskScreenHistory, DiskU[language_index]);

    ui_ImgUsbRightHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    memset(tempbuffa, 256, 0);
    snprintf(tempbuffa, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TitleRightstyle.png");
    lv_img_set_src(ui_ImgUsbRightHistoryPage, tempbuffa);
    lv_obj_set_width(ui_ImgUsbRightHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgUsbRightHistoryPage, LV_SIZE_CONTENT);

    ui_ImgHistoryLeftHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    memset(tempbuffb, 256, 0);
    snprintf(tempbuffb, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TilteLeftstyle.png");
    lv_img_set_src(ui_ImgHistoryLeftHistoryPage, tempbuffb);
    lv_obj_set_width(ui_ImgHistoryLeftHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgHistoryLeftHistoryPage, LV_SIZE_CONTENT);

    ui_ButtonPrintHistoryFileScreenHist = lv_btn_create(ui_PanelFileOptScreenHistory);
    lv_obj_set_width(ui_ButtonPrintHistoryFileScreenHist, 161);
    lv_obj_set_height(ui_ButtonPrintHistoryFileScreenHist, 46);
    ...
    lv_obj_set_style_text_color(ui_ButtonPrintHistoryFileScreenHist, lv_color_hex(0xFFFFFF),LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_ButtonPrintHistoryFileScreenHist, lv_font25.font,LV_PART_MAIN | LV_STATE_DEFAULT);
    ui_LabelPrintHistoryScreenHist = lv_label_create(ui_ButtonPrintHistoryFileScreenHist);
    lv_obj_set_width(ui_LabelPrintHistoryScreenHist, 155);
    lv_obj_set_height(ui_LabelPrintHistoryScreenHist, 35);
    lv_obj_align(ui_LabelPrintHistoryScreenHist, LV_ALIGN_CENTER, 0, 0);
    lv_label_set_text(ui_LabelPrintHistoryScreenHist, History[language_index]);

    ui_ImgHistoryRightHistoryPage = lv_img_create(ui_PanelFileOptScreenHistory);
    memset(tempbuffa, 256, 0);
    snprintf(tempbuffa, 256, "S:%s/%s", GetK1ImageResourcePtah(), "TitleRightstyle.png");
    lv_img_set_src(ui_ImgHistoryRightHistoryPage, tempbuffa);
    lv_obj_set_width(ui_ImgHistoryRightHistoryPage, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_ImgHistoryRightHistoryPage, LV_SIZE_CONTENT);

    //标题栏显示效果初始化
    lv_obj_set_style_img_opa(ui_ImgLocalLeftHistoryPage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui_ImgLocalRightHistoryPage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui_ImgUsbLeftHistoryPage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui_ImgUsbRightHistoryPage, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui_ImgHistoryLeftHistoryPage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui_ImgHistoryRightHistoryPage, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PanelCenterScreenHistory = lv_obj_create(ui_ScreenPrintHistory);
    lv_obj_set_width(ui_PanelCenterScreenHistory, 720);
    lv_obj_set_height(ui_PanelCenterScreenHistory, 430);
    lv_obj_set_x(ui_PanelCenterScreenHistory, 80);
    lv_obj_set_y(ui_PanelCenterScreenHistory, 50);
    ...
    lv_obj_set_style_pad_all(ui_PanelCenterScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PanelPrinteFileListScreenHistory = lv_obj_create(ui_PanelCenterScreenHistory);
    lv_obj_set_width(ui_PanelPrinteFileListScreenHistory, 696);
    lv_obj_set_height(ui_PanelPrinteFileListScreenHistory, 406);
    lv_obj_align(ui_PanelPrinteFileListScreenHistory, LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_set_style_pad_all(ui_PanelPrinteFileListScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PanelListHeadScreenHistory = lv_obj_create(ui_PanelPrinteFileListScreenHistory);
    lv_obj_set_width(ui_PanelListHeadScreenHistory, 696);
    lv_obj_set_height(ui_PanelListHeadScreenHistory, 50);
    lv_obj_align(ui_PanelListHeadScreenHistory, LV_ALIGN_TOP_LEFT, 0, 0);
    ...
    lv_obj_set_style_pad_all(ui_PanelListHeadScreenHistory, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_LabelFileNameScreenHistory = lv_label_create(ui_PanelListHeadScreenHistory);
    lv_obj_set_width(ui_LabelFileNameScreenHistory, 200);
    lv_obj_set_height(ui_LabelFileNameScreenHistory, 36);
    lv_obj_align(ui_LabelFileNameScreenHistory, LV_ALIGN_LEFT_MID, 0, 0);
    ...
    lv_obj_set_style_text_align(ui_LabelFileNameScreenHistory, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_align(ui_LabelStartTimeScreenHistory, LV_ALIGN_LEFT_MID, 286, 0);
    ...
    lv_obj_set_style_text_align(ui_LabelStartTimeScreenHistory, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_LabelTotleTimeScreenHistory, 180);
    lv_obj_set_height(ui_LabelTotleTimeScreenHistory, 36);
    lv_obj_align(ui_LabelTotleTimeScreenHistory, LV_ALIGN_LEFT_MID, 470, 0);
    ...
    lv_obj_set_style_text_align(ui_LabelTotleTimeScreenHistory, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_align(ui_LabelStatusScreenHistory, LV_ALIGN_LEFT_MID, 610, 0);
    ...
    lv_obj_set_style_text_align(ui_LabelStatusScreenHistory, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_LabelNoContentsPromptScreenHisto, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_LabelNoContentsPromptScreenHisto, 38);
    lv_obj_align(ui_LabelNoContentsPromptScreenHisto, LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_align(ui_PanelLineScreenHistory, LV_ALIGN_TOP_MID, 0, 53);
    ...
    int index = 0;
    print_record[index++] = create_custom_print_history_part(ui_PanelPrinteFileListScreenHistory, 0, 58+22);
    print_record[index++] = create_custom_print_history_part(ui_PanelPrinteFileListScreenHistory, 0, 164+22);
    print_record[index++] = create_custom_print_history_part(ui_PanelPrinteFileListScreenHistory, 0, 270+22);
    ...
    lv_obj_set_style_bg_opa(ui_PanelPrevFilesPageScreenHistory, 150, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_opa(ui_PanelPrevFilesPageScreenHistory, 190, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui_PanelNextFilesPageScreenHistory, 150, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_opa(ui_PanelNextFilesPageScreenHistory, 190, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void history_set_print_record_info(print_record_info_t record_arry[3], int real_record_count)
{
    ...
    if ( real_record_count == 0)
    {
        ...
        lv_label_set_text(ui_LabelNoContentsPromptScreenHisto, NoRecords[index]);
...
void history_change_language_text(void)
{
    ...
    {
        lv_label_set_text(ui_LabelLocalScreenHistory, Local[language_index]);
        redefine_label_size(ui_LabelLocalScreenHistory, lv_font25.font, 0, 0, 360, 0);
        
        lv_obj_update_layout(ui_ButtonLocalFileScreenHistory);
        redefine_widgets_size(ui_ButtonLocalFileScreenHistory, ui_LabelLocalScreenHistory, 5, 0, 146, 46);
    }
    
    if ( ui_LabelUDiskScreenHistory )
    {
        lv_label_set_text(ui_LabelUDiskScreenHistory, DiskU[language_index]);
        redefine_label_size(ui_LabelUDiskScreenHistory, lv_font25.font, 0, 0, 360, 0);
        
        lv_obj_update_layout(ui_ButtonUsbFileScreenHistory);
        redefine_widgets_size(ui_ButtonUsbFileScreenHistory, ui_LabelUDiskScreenHistory, 5, 0, 146, 46);
    }

    if ( ui_LabelPrintHistoryScreenHist )
    {
        lv_label_set_text(ui_LabelPrintHistoryScreenHist, History[language_index]);
        redefine_label_size(ui_LabelPrintHistoryScreenHist, lv_font25.font, 0, 0, 360, 0);
        
        lv_obj_update_layout(ui_ButtonPrintHistoryFileScreenHist);
        redefine_widgets_size(ui_ButtonPrintHistoryFileScreenHist, ui_LabelPrintHistoryScreenHist, 5, 0, 146, 46);
    }
