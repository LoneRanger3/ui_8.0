...
void ui_laser_flow_test_init(lv_obj_t* parents) 
{
    ...
    lv_obj_set_size(flow_test_obj,800,480);
    ...
    lv_obj_align_to(laser_flow_start_btn, flow_test_obj, LV_ALIGN_TOP_LEFT, 150, 225);
    ...
    lv_obj_align_to(return_btn, flow_test_obj, LV_ALIGN_TOP_LEFT, 20, 20);
